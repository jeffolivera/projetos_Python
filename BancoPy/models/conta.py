...
from utills.helper import formata_float_para_moeda

class Conta:
    codigo: int = 1001 #numero definido pelo programador
    ...
    def __str__(self: object) -> str:
        return f'Número da conta: {self.numero} \nCliente: {self.cliente.nome} ' \
               f'\nSaldo Total: {formata_float_para_moeda(self.saldo_total)}'
